...
A locally enhanced fork of the DSH Web "select-and-quote" plugin, maintained at v0.3.6. The package carries the independent fork name `@dsh-external/dsh-annotation-patched` so its releases never collide with upstream ones.
